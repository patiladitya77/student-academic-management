...
class Cie1Screen extends StatefulWidget {
  ...
  @override
  State<Cie1Screen> createState() => _MarksScreenState();
}

class _MarksScreenState extends State<Cie1Screen> {
  bool isLoading = true;
      ...
      for (String cours in widget.course) {
        ...
        if (marksDoc.exists) {
          ...
          if (data != null && data.containsKey(widget.id)) {
            ...
            courseMarks[cours] = studentData['totalMarks']?.toDouble() ?? 0.0;
          } else {
            courseMarks[cours] = 0.0; // No marks found for the student in this course
          }
        } else {
          courseMarks[cours] = 0.0; // Document does not exist
        }
      }
    } catch (e) {
